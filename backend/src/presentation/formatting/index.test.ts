...
describe("formatRatio", () => {
  // 1.4.16. FORMATS TO EXACTLY TWO DECIMALS .........................................................
  it("formats a ratio to exactly two decimal places", () => {
    assert.equal(formatRatio(1.875), "1.88");
  });
  // 1.4.16. END .....................................................................................

  // 1.4.17. KEEPS TRAILING ZEROES ...................................................................
  it("keeps trailing zeroes for a whole-number ratio", () => {
    assert.equal(formatRatio(2), "2.00");
  });
  // 1.4.17. END .....................................................................................

  // 1.4.18. PRESERVES THE NEGATIVE SIGN .............................................................
...
describe("formatSharePrice", () => {
  // 1.4.19. FORMATS A SHARE PRICE TO EXACTLY TWO DECIMALS ...........................................
  it("formats a share price to exactly two decimals with a dollar prefix", () => {
    assert.equal(formatSharePrice(203.456), "$203.46");
  });
  // 1.4.19. END .....................................................................................

  // 1.4.20. KEEPS TRAILING ZEROES FOR WHOLE DOLLARS .................................................
  it("keeps trailing zeroes for whole-dollar share prices", () => {
    assert.equal(formatSharePrice(200), "$200.00");
  });
  // 1.4.20. END .....................................................................................

  // 1.4.21. PRESERVES THE NEGATIVE SIGN FOR NEGATIVE SHARE PRICES ...................................
  it("preserves the negative sign for negative share prices", () => {
    assert.equal(formatSharePrice(-5.5), "$-5.50");
  });
  // 1.4.21. END .....................................................................................
});

describe("calculateConsolidatedSummary", () => {
  // 1.4.22. RETURNS THE PLACEHOLDER SUMMARY FOR AN ..................................................
  ...
  // 1.4.23. AVERAGES MULTIPLE VALUES AND FORMATS AS PERCENT .........................................
  ...
  // 1.4.24. COMPUTES THE MEAN OF TWO VALUES .........................................................
  ...
  // 1.4.25. HANDLES A SINGLE VALUE WITHOUT DIVIDING .................................................
  ...
  // 1.4.26. APPLIES THE SUPPLIED FORMATTER TO VALUES AND MEAN .......................................
